...
const exceptionSales = require('../../models/exceptionsSales')
        ...
        for (const id of ids){
            ...
            if (id != 'powernet'){
                sales.forEach(async (sale)=>{
                    ...
                    if (sale[partner['Transaction_ID']] != null){
                        console.log(await partnerSales.insert({
                            ...
                            "messageId": partner['Message_ID'] === null ? null : sale[partner['Message_ID']]
                        }))
                    }
                    else{
                        console.log(await exceptionSales.insert({
                            "type": "partner",
                            "partnerId": partner['Partner_ID'] === null ? partner['Partner_Name'] : sale[partner['Partner_ID']], 
                            "token": partner['Token'] === null ? null : sale[partner['Token']], 
                            "amount": partner['Amount'] === null ? null : sale[partner['Amount']], 
